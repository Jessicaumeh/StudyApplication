...
class StudiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create study" do
    assert_difference("Study.count") do
      post studies_url, params: { study: { completed: @study.completed, started: @study.started, title: @study.title } }
    end
  ...
  test "should update study" do
    patch study_url(@study), params: { study: { completed: @study.completed, started: @study.started, title: @study.title } }
